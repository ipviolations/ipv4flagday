'use strict';
( function () {
	const API_URL = new URL( '/resolve', 'https://dns.google.com' ); // URL object not supported in MS IE
	const API_METHOD = 'GET';
	const INPUT_NAME = 'name';
	const PARAM_JSON_NAME = 'type';
	const PARAM_JSON_VALUE = 'AAAA';
	...
	const createSingleResultElement = function ( /** @type {{}} */ json, /** @type {String} */ name ) {
		...
		const test_result = eval_domain(json['Answer'])
		switch (test_result) {
			case 'ok':
